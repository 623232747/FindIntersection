...
//        Segment e = new Segment("blue",new Point(9f, 1f), new Point(7f, 6f));
...
//        Segment c = new Segment("3",new Point(3f,1f),new Point(4f,4f));
//        Segment d = new Segment("4",new Point(4f,1f),new Point(3f,4f));
